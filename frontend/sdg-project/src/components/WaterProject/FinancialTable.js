              ...
              <TableBody>
                {rows.map((row) => (
                  <TableRow key={row.bondName}>
                    ...
                    <StyledTableCell align="left">${row.uop}</StyledTableCell>
                    <StyledTableCell align="left">${row.recentSpending}</StyledTableCell>
                    <StyledTableCell align="left">${row.priorSpending}</StyledTableCell>
